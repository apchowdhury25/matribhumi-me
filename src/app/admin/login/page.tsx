...
export default function AdminLoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-charcoal px-6">
      <form action={action} className="w-full max-w-md border border-ivory/10 bg-ink p-8 text-ivory">
        <Logo variant="dark" />
        ...
        <label className="mt-8 grid gap-2 text-[11px] uppercase tracking-[0.18em] text-sand">
          Email
          <input name="email" type="email" required className="h-11 bg-charcoal px-3 text-sm text-ivory" />
        </label>
        <label className="mt-4 grid gap-2 text-[11px] uppercase tracking-[0.18em] text-sand">
          Password
          <input name="password" type="password" required className="h-11 bg-charcoal px-3 text-sm text-ivory" />
        </label>
